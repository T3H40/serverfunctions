...
tellraw @a {"text":"Teleporting ", "extra":[{"selector": "@s"}, {"text": " -> "}, {"nbt":"HandItems[1].components.minecraft:custom_name","entity":"@e[tag=do_fast_travel]", "interpret": true}] }
...
scoreboard players add @s numberOfTeleports 1
